    ...
    <div class="container">
        ...
        <div class="info-grid">
            <div>
                <table class="table-info">
                    <tr><td>Nama Peserta</td><td>: <?php echo htmlspecialchars($data['nama_siswa']); ?></td></tr>
                    <tr><td>Nomor Peserta</td><td>: <?php echo htmlspecialchars($data['kartu_peserta']); ?></td></tr>
                    <tr><td>Kelas</td><td>: <?php echo htmlspecialchars($data['kelas']); ?></td></tr>
                    <tr><td>Mata Pelajaran</td><td>: <strong><?php echo htmlspecialchars($data['mata_pelajaran']); ?></strong></td></tr>
                    <tr><td>Waktu Mulai</td><td>: <?php echo date('d-m-Y H:i:s', strtotime($data['waktu_mulai'])); ?> WIB</td></tr>
                    <tr><td>Waktu Selesai</td><td>: <?php echo date('d-m-Y H:i:s', strtotime($data['waktu_selesai'])); ?> WIB</td></tr>
                    <tr><td>Lama Ujian</td><td>: <?php echo $durasi; ?></td></tr>
                </table>
            </div>
            <div class="selfie-box">
                ...
                <?php else: ?>
                    <div style="width:150px; height:200px; border:2px dashed #ccc; display:inline-flex; align-items:center; justify-content:center; color:#999; font-size: 12px; border-radius: 8px; float: right;">Foto Tidak Tersedia</div>
                <?php endif; ?>
            </div>
        </div>

        <div class="score-cards">
            <div class="card-stat"><h4>NILAI AKHIR</h4><div class="value val-nilai"><?php echo (int)($data['nilai'] ?? 0); ?></div></div>
            <div class="card-stat"><h4>JAWAB BENAR</h4><div class="value val-benar"><?php echo (int)($data['benar'] ?? 0); ?></div></div>
            <div class="card-stat"><h4>JAWAB SALAH</h4><div class="value val-salah"><?php echo (int)($data['salah'] ?? 0); ?></div></div>
            <div class="card-stat"><h4>PELANGGARAN</h4><div class="value val-langgar"><?php echo (int)($data['jumlah_pelanggaran']); ?>x</div></div>
        </div>
        ...
        <div class="review-section">
            ...
            <?php else: ?>
                ...
                ?>
                    <div class="soal-item">
                        <div style="font-weight: bold; margin-bottom: 10px; color: #007bff; border-bottom: 1px solid #eee; padding-bottom: 5px;">
                            Soal No. <?php echo $index + 1; ?>
                        </div>

                        <?php if (empty($jawaban_terpilih)): ?>
                            <div class="alert-kosong">⚠️ Siswa tidak menjawab soal ini</div>
                        <?php endif; ?>

                        <?php if (!empty($soal['deskripsi'])): ?>
                            <div class="soal-deskripsi"><?php echo htmlspecialchars_decode($soal['deskripsi']); ?></div>
                        <?php endif; ?>
                        ...
                        <div class="soal-pertanyaan"><?php echo htmlspecialchars_decode($soal['pertanyaan']); ?></div>
                                ...
                                <li class="<?php echo $class_li; ?>">
                                    ...
                                    <div style="flex-grow: 1;">
                                        ...
                                        <?php if (!empty($gbr_opsi)): ?>
                                            <div style="margin-top: 5px;"><img src="../uploads/<?php echo htmlspecialchars($gbr_opsi); ?>" class="img-soal" style="max-height: 80px;"></div>
                                        <?php endif; ?>
                                    </div>
                                    <?php echo $badge; ?>
                                </li>
