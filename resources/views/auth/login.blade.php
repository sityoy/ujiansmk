...
<head>
    ...
    <title>Masuk — {{ config('app.name', 'GALAK CBT') }}</title>
        ...
        <section class="relative w-full max-w-5xl overflow-hidden rounded-[2rem] border border-white/10 bg-slate-900/80 shadow-2xl shadow-black/40 backdrop-blur-xl lg:grid lg:grid-cols-[1.1fr_.9fr]">
            <div class="relative hidden min-h-[640px] overflow-hidden bg-gradient-to-br from-cyan-400 via-sky-500 to-blue-700 p-10 text-slate-950 lg:flex lg:flex-col lg:justify-between">
                ...
                <div class="relative flex items-center gap-3">
                    <span class="grid size-12 place-items-center rounded-2xl bg-slate-950 text-xl font-bold text-cyan-300">G</span>
                    <div>
                        <p class="font-semibold tracking-wide">GALAK CBT</p>
                        <p class="text-xs font-medium text-slate-800/70">Sistem Asesmen Sekolah</p>
                    </div>
                </div>
                ...
                <p class="relative text-xs font-medium text-slate-900/60">GALAK CBT · Assessment Control Center</p>
            </div>

            <div class="px-6 py-9 sm:px-10 lg:px-12 lg:py-14">
                <div class="mb-9 lg:hidden">
                    <div class="flex items-center gap-3">
                        <span class="grid size-11 place-items-center rounded-2xl bg-cyan-400 font-bold text-slate-950">G</span>
                        <div>
                            <p class="font-semibold">GALAK CBT</p>
                            <p class="text-xs text-slate-400">Sistem Asesmen Sekolah</p>
                        </div>
                    </div>
                </div>
